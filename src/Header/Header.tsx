...
function Header(){
  const price = useAppSelector(state => state.cardSlice.totalPrice)
  const count = useAppSelector(state => state.cardSlice.totalCount)
